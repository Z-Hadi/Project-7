...
<div>
  <CreatePost @submit="createPost" />
    ...
    <div v-for="(post, index) in posts" :key="index" >
      ...
      <ThePostPage :author="post.author"  :time="post.timestamp" :title="post.title" :body="post.body" :seen="post.seen"> </ThePostPage>
  ...
  data: ()=> ({
    ...
    posts: [
     ...
     author: 'Zaid Hadi1124',
      ...
      time: '22/06/2022',
      title: 'Post-2',
      body:'this the body for post one' ,
      seen:'15'
      },
      {
      author: 'Zaid',
...
const formData = new FormData()
  ...
  formData.append('seen', payload.seen)
